...
fileNames = ['spatiocyte/spatiocyte_andrews_2018.csv','spatiocyte/spatiocyte_small_dt.csv','smoldyn/smoldyn_andrews_2018.csv','smoldyn/smoldyn_small_dt.csv','egfrd/egfrd.csv', 'egfrd/egfrd_small_r.csv','spatiocyte/ode_andrews_2018.csv',]
